...
//         console.log(this)
//         //quando se usa "this" não usa function "como err =>"
//     }

//     db.run(query, values, afterInsetData)

//     //3consultar os dados da tabela
//     // * significa "tudo", mas é possível pedir apenas uma coluna da tabela (name, state, city, etc..)
...
//     //4deletar um dado da tabela - alterar registro no [] de acordo com o id a ser deletado
